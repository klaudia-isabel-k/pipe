...
def log_alert(s,date_t,history_flag):
    ...
    if log_alert_flag == 1:
        print("Alert for '{}' security under '{}' user has been stored in the history table.".format(s['security'],s['user_login']))
    ...
    if send_alert_flag == 1:
        print("Email alert sent out for '{}' security to '{}' user.".format(s['security'],s['user_login']))
...
def main(security, value, date_t, date_alert_cutoff):
    ...
    try:
        ...
        print("Starting alert logic process for '{}' security...".format(security))
        ...
        if subscription.empty:
            ...
            print("Alert logic completed for '{}' security...".format(security))
